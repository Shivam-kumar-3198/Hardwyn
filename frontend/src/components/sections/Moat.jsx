...
export default function Moat() {
  return (
    <section id="moat" className="border-y border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 py-24 md:py-32">
      <Container>
        ...
        <div className="mt-10 grid gap-12 lg:grid-cols-[1.2fr_1fr] lg:items-center lg:gap-20">
          <ScrollReveal>
            <SectionTitle>
              One listed name in
              <br />
              <span className="text-crimson-deep">architectural hardware.</span>
              <br />
          ...
          <ScrollReveal delay={0.15}>
            <div className="relative mb-8 h-52 overflow-hidden border border-neutral-200 dark:border-neutral-700">
              <img
              ...
              <span className="absolute bottom-3 left-4 font-mono text-[10px] uppercase tracking-widest text-white/90">
            ...
            <div className="space-y-6 pt-2 text-base leading-relaxed text-neutral-700 dark:text-neutral-300 md:text-lg">
              <p>
              ...
              <p className="border-l-2 border-crimson-deep pl-4 font-mono text-sm text-neutral-600 dark:text-neutral-400">
